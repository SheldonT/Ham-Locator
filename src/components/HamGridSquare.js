 ...
 */
export function gridForLatLon(latitude, longitude) {
 ...
 */
export function latLonToGridSquare(param1, param2) {
  var lat = 0.0;
  var lon = 0.0;
 ...
 */
export function latLonForGrid(grid) {
  var lat = 0.0;
  var lon = 0.0;
 ...
 * * a `LatLon` object if...
 */
export function gridSquareToLatLon(grid, obj) {
